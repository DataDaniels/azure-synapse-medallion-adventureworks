...
> ⬅️ Voltar ao [README principal](https://github.com/DataDaniels/azure-synapse-medallion-adventureworks/blob/main/README.md) · Veja também o [Code Walkthrough (PySpark)](https://github.com/DataDaniels/azure-synapse-medallion-adventureworks/blob/main/docs/CODE_WALKTHROUGH.md)
...
> 🔍 Quer ver o código PySpark comentado por trás de cada uma dessas etapas? Veja o [Code Walkthrough](https://github.com/DataDaniels/azure-synapse-medallion-adventureworks/blob/main/docs/CODE_WALKTHROUGH.md).
