...
- 🏗️ **[docs/ARCHITECTURE.md](docs/ARCHITECTURE.md)** — arquitetura completa, camadas do Data Lake, validação de execução no Synapse, modelagem Power BI, dashboard e insights de negócio.
- 💻 **[docs/CODE_WALKTHROUGH.md](docs/CODE_WALKTHROUGH.md)** — trechos comentados dos notebooks PySpark (ingestão dinâmica, surrogate keys, geração da `dimDate`, construção da fato de vendas), prontos para copiar e reutilizar.
...
📄 Análise completa de lucratividade, clientes de alto valor e sazonalidade em [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md#-insights-de-negócio--respostas-analíticas).
...
│
├── docs/
│   ├── ARCHITECTURE.md                   # Arquitetura completa, BI e insights de negócio
│   └── CODE_WALKTHROUGH.md               # Trechos comentados dos notebooks PySpark
│
├── architecture/
